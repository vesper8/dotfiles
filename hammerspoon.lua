...
function config()
  ...
  hs.hotkey.bind(cmd_alt_ctrl, "l", function()
        hs.execute("open ~/DEV")
        hs.execute("open ~/ns.develop")
        hs.execute("open ~/mad.spawner")
        hs.execute("open ~/biz.kijiji")
        hs.application.launchOrFocus('Finder')
  end)


  hs.hotkey.bind(cmd_alt_ctrl, "f", function()
        hs.execute("open ~/DEV/___db_dumps")
        hs.execute("open ~/fog.www")
        hs.execute("open ~/fog.www/storage/app/public/submissions/")
...
-- hs.hotkey.bind({"fn"}, "f8", function() hs.alert("pressed f10") end)
-- hs.hotkey.bind({}, "f8", function() hs.alert("pressed f10") end)
-- hs.hotkey.bind({"ctrl", "alt"}, "H", function() hs.alert("pressed f10") end)
